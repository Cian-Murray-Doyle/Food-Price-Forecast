...
# Import again, removing irrelevant columns
...
# Test the function on new data
plot_price_forecast(pea_time_series, "Pea")

# Code is complete now we can test on any of our commodity datasets
